...
export class AppComponent implements AfterViewInit {
  ...
  modType: string | undefined = undefined;
  ...
  provideZLUXDispatcherCallbacks(): any {
    return {
  ...
  loadConfig(): Observable<ConfigServiceTerminalConfig> {
    ...
    return this.http.get<ConfigServiceTerminalConfig>('_defaultTN3270.json')
  }

  loadZssSettings(): Observable<ZssConfig> {
    return this.http.get<ZssConfig>("server/proxies")
  }

  saveSettings() {
    this.http.put('_defaultTN3270.json',
      {
        deviceType: Number(this.modType),
