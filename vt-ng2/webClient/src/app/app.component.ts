...
export class AppComponent implements AfterViewInit {
  ...
  port: number = 0;
  securityType: string|undefined = undefined;
  connectionSettings: any = undefined;
  errorMessage: string = '';
  terminalDivStyle: any = undefined;
  ...
  constructor(
    ...
    @Inject(Angular2InjectionTokens.LOGGER) private log: any,
    @Inject(Angular2InjectionTokens.PLUGIN_DEFINITION) private pluginDefinition: any,
    @Inject(Angular2InjectionTokens.VIEWPORT_EVENTS) private viewportEvents: any,
    @Optional() @Inject(Angular2InjectionTokens.WINDOW_ACTIONS) private windowActions: any,
...
//    log.info("JOE.vt app comp, dispatcher="+dispatcher);
    ...
    if (this.windowActions) {
      this.terminal.contextMenuEmitter.subscribe( (info) => {
        ...
        log.info("app.comp subcribe lambda, dispatcher=foo");
        /*
    ...
    if (!this.connectionSettings) {
      log.info('NYI: connecting without app2app');
      /*
