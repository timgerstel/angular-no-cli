...
export class Terminal {
  ...
  connectToHost(rendererSettings: any, connectionSettings: any) {
    ...
    let plugin:any = this.pluginDefinition.getBasePlugin();

    connectionSettings.url = 'foo';//ZoweZLUX.uriBroker.pluginWSUri(plugin, 'terminalstream', '');
